...
public class mer_rule_Rule1018 extends mer_rule {
  public mer_rule_Rule1018() {
       this.setRuleID("Rule1018");
  ...
  public void callRule(final Session session) {
    ...
    for ( Fact<Mer> factmer : session.getWorkingMemory().getFact( Mer.class )){
       ...
       if (factmer.getFactStatus()!=FactStatus.DELETE && rules_Mer_mer_it(mer)) {
             ...
             rules_Rule1018_action(session,mer);
  ...
  public void rules_Rule1018_action(final SessionInterface it, final Mer mer) {
