...
public class UserBlackXList {
	...
	public void findOffenceMng(ILog logger) throws Exception {
		StringBuffer sql = new StringBuffer("select * from RCS_OFFENCE_INFO a where CUST_TYPE='0' ");
		...
		Msg.set(TdWebConstants.WEB_FORWARD_NAME, "/WEB-INF/html/xList/userBlackXList.jsp");
	}
	...
	public void addLUser() throws Exception {
		Etf.setChildValue("RspCod", "000000");
		Etf.setChildValue("RspMsg", "打开黑名单-用户增加");
		Etf.setChildValue(TdWebConstants.WEB_FORWARD_NAME,"/WEB-INF/html/xList/addUserBlack.jsp");
	}
	...
	public void addOffence() throws Exception {
		...
		if (result == 0) {
			...
			Etf.setChildValue("FORWARDURL", "540401.tran");
	...
	public void singleFindOffence(ILog logger) throws Exception {
		...
		Msg.set(TdWebConstants.WEB_FORWARD_NAME,"/WEB-INF/html/xList/singleFindUserBlack.jsp");
	}
