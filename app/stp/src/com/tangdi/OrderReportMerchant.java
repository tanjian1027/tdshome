...
public class OrderReportMerchant
{
  ...
  public static int ToReport(@Named("Root") String Root, @Named("FileDemo") String FileDemo, @Named("FilePath") String FilePath, @Named("FileToPath") String FileToPath, @Named("NameForUser") String NameForUser, @Named("WebPath") String WebPath)
  {
    ...
    if (FileDemo.equals("orderdemomerchant"))
    ...
    try {
      ...
      Log.info("file=%s", new Object[] { WebPath + FileToPath + "/" + fileName + "没找到" });
      return 1;
    }
      ...
      if (em.element("ORDSTATUS") == null) { order.setOrdStatus("无记录");
        ...
        case 1:
          ...
          case 1:
            ...
            break;
          case 2:
            order.setOrdStatus("预付款");
            break;
          case 3:
            order.setOrdStatus("延迟付款审核中");
            break;
          case 4:
            order.setOrdStatus("冻结");
            break;
          case 5:
            order.setOrdStatus("同意延迟付款");
            break;
          case 6:
            order.setOrdStatus("拒绝延迟付款");
          }
